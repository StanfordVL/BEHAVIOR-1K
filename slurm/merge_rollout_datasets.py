...
def main():
    input_root = pathlib.Path("/checkpoint/clear/cgokmen/lerobot_datasets/vid2room-train")
    output_root = pathlib.Path("/checkpoint/clear/cgokmen/merged_lerobot_datasets")
    max_videos = 100
