...
#SBATCH --job-name=convert_hssd_scenes
#SBATCH --output=/home/cgokmen/projects/BEHAVIOR-1K/slurm/logs/convert_hssd_scenes-%A_%a.log
#SBATCH --error=/home/cgokmen/projects/BEHAVIOR-1K/slurm/logs/convert_hssd_scenes-%A_%a.log
#SBATCH --array=0-255
...
# --- Configuration ---
SCRIPT_NAME="convert_hssd_scenes"
NUM_JOBS=${1:-8}
