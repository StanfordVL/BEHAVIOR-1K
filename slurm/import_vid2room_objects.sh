...
#SBATCH --output=/cvgl2/u/cgokmen/BEHAVIOR-1K/slurm/logs/import_vid2room_objects-%A_%a.log
#SBATCH --error=/cvgl2/u/cgokmen/BEHAVIOR-1K/slurm/logs/import_vid2room_objects-%A_%a.log
#SBATCH --array=0-15
...
while [ ! -f "${SUCCESS_FILE}" ]; do
  ...
  OMNIGIBSON_APPDATA_PATH=/scr/cgokmen/omnigibson_${GPU_ID}_cache python -u -m omnigibson.examples.objects.import_vid2room_objects \
