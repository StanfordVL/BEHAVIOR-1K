...
#SBATCH --output=logs-bigrun2/policy-pi05-%A_%a.log
#SBATCH --error=logs-bigrun2/policy-pi05-%A_%a.log
#SBATCH --array=0-3
...
lerobot-train \
  ...
  --output_dir=/checkpoint/clear/cgokmen/policies-bigrun2/pi05-${DATASET}-${SLURM_JOB_ID} \
