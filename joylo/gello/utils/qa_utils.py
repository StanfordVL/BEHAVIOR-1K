...
def check_robot_self_collision(env):
    ...
    for robot in env.robots:
        ...
        if RigidContactAPI.is_in_contact(env.scene.idx, link_paths, with_set=link_paths, ignore_set=None, current=False):
            return True
    return False
...
def check_robot_base_nonarm_nonkinematic_collision(env):
    ...
    for robot in env.robots:
        ...
        if RigidContactAPI.is_in_contact(env.scene.idx, robot_link_paths, with_set=None, ignore_set={robot}, current=False):
            return True
...
def check_robot_nonarm_nonground_collision(env):
    ...
    for robot in env.robots:
        ...
        if RigidContactAPI.is_in_contact(env.scene.idx, non_arm_links, with_set=None, ignore_set=ground_objects + [robot], current=False):
            return True
