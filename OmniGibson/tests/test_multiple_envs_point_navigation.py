...
# ===================================================================
#  Section 1 – Task / reward / termination tensor tests (PointNavigationTask)
# ===================================================================


@pytest.mark.parametrize("robot", MULTI_ENV_ROBOTS)
class TestTaskTensors:
    """Verify that PointNavigationTask step outputs have correct tensor shapes across robots."""
...
# ===================================================================
#  Section 2 – Navigation-specific tests (PointNavigationTask)
# ===================================================================


@pytest.mark.parametrize("robot", MULTI_ENV_ROBOTS)
class TestNavigationTasks:
    """Goal-based PointNavigationTask tests across robots."""
