...
def main():
    ...
    parser.add_argument(
        "--mesh-subdir", type=str, default="obj_meshes_v9_pointmap", help="Subdirectory containing the meshes"
    )
    ...
    parser.add_argument("--target-face-count", type=int, default=10000, help="Target face count for decimation")
