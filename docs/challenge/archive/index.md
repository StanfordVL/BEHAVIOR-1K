...
The 1st BEHAVIOR Challenge tasked participants with solving 50 full-length household tasks in
the BEHAVIOR-1K environment, supported by 10,000 teleoperated expert demonstrations
(1,200+ hours).

- [Overview](2025/index.md)
- [Call for Participation](2025/call_for_participation.md)
- [Leaderboard](2025/leaderboard.md)
- [Dataset](2025/dataset.md)
- [Baselines](2025/baselines.md)
