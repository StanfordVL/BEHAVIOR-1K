...
from vid2scene_policy.data_collection.lerobot_datasets.datasets.compute_stats import aggregate_stats, compute_episode_stats
from vid2scene_policy.data_collection.lerobot_datasets.datasets.image_writer import AsyncImageWriter, write_image
from vid2scene_policy.data_collection.lerobot_datasets.datasets.utils import (
...
from vid2scene_policy.data_collection.lerobot_datasets.datasets.video_utils import (
    VideoFrame,
...
from vid2scene_policy.data_collection.lerobot_datasets.utils.constants import HF_LEROBOT_HOME
...
def _encode_video_worker(
    ...
    # Use yuv444p for h264 to preserve all color channels (important for depth in blue channel)
    pix_fmt = "yuv444p" if vcodec == "h264" else "yuv420p"
    encode_video_frames(img_dir, temp_path, fps, vcodec=vcodec, pix_fmt=pix_fmt, overwrite=True)
